...
<footer id="footer" class="page-footer unique-color-dark mt-4">
  ...
  <div class="footer-copyright py-3 text-center">
    ...
    <script type="text/javascript" src="/php/htmlprojects/layout/js/popper.js"></script>
    <script type="text/javascript" src="/php/htmlprojects/layout/js/bootstrap.js"></script>
</body>
</html>
