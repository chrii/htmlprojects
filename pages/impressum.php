...
<main role="main" class="container">
    ...
    <br/>
        <address >Chris Pintarich<br/>
        ****, ***, <br/>
        1100 Wien, <br/>
        Österreich<br/>
        Tel.: 068120707535<br/>
        Fax: -<br/>
        E-Mail: c.pintarich@gmail.com<br/></address>
        </div>
    <div class="container border-bottom">
        <h1 class="display-4 ">EU-Streitschlichtung</h1>
        ...
        Verbraucher haben die Möglichkeit, Beschwerden an die Online Streitbeilegungsplattform der Europäischen Kommission unter http://ec.europa.eu/odr zu richten. Die dafür notwendigen Kontaktdaten finden Sie oberhalb in unserem Impressum.</p>
        <p>Wir möchten Sie jedoch darauf hinweisen, dass wir nicht bereit oder verpflichtet sind, an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.</P>
        <br/>
    </div>
    <div class="container border-bottom">
        <h1 class="display-4">Haftung für Inhalte dieser Webseite</h1>
    ...
    <div class="container border-bottom">
        <h1 class="display-4">Haftung für Links auf dieser Webseite</h1>
        <p>Unsere Webseite enthält Links zu anderen Webseiten für deren Inhalt wir nicht verantwortlich sind. Haftung für verlinkte Websites besteht laut § 17 ECG für uns nicht, da wir keine Kenntnis rechtswidriger Tätigkeiten hatten und haben, uns solche Rechtswidrigkeiten auch bisher nicht aufgefallen sind und wir Links sofort entfernen würden, wenn uns Rechtswidrigkeiten bekannt werden.</p>  
        <p>Wenn Ihnen rechtswidrige Links auf unserer Website auffallen, bitte wir Sie uns zu kontaktieren, Sie finden die Kontaktdaten im Impressum.</p>
        <br/>
    </div>
    <div class="container border-bottom">
        <h1 class="display-4" id="disclaimer">Urheberrechtshinweis</h1>
    ...
    <div class="container border-bottom">
        <h1 class="display-4">Bildernachweis</h1>
    ...
    <div class="container border-bottom">
        <h1 class="display-4" id="datenschutz">Datenschutzerklärung</h1>
    <strong>Datenschutz</strong>
    <p>Wir haben diese Datenschutzerklärung (Fassung 14.07.2018-221067658) verfasst, um Ihnen gemäß der Vorgaben der Datenschutz-Grundverordnung (EU) 2016/679 und dem Datenschutzgesetz (DSG) zu erklären, welche Informationen wir sammeln, wie wir Daten verwenden und welche Entscheidungsmöglichkeiten Sie als Besucher dieser Webseite haben.</p>
    ...
    <p>Ein Cookie ist ein kurzes Datenpaket, welches zwischen Webbrowser und Webserver ausgetauscht wird, für diese aber völlig bedeutungslos ist und erst für die Webanwendung, z. B. einen Online-Shop, eine Bedeutung erhält, etwa den Inhalt eines virtuellen Warenkorbes.</p>

    <p>Es gibt zwei Arten von Cookies: <small> Erstanbieter-Cookies werden von unserer Website erstellt, Drittanbieter-Cookies werden von anderen Websites (z. B. Google Analytics) erstellt.</small></p>
    <p>Man unterscheidet drei Kategorien von Cookies: <small>unbedingt notwendige Cookies um grundlegende Funktionen der Website sicherzustellen, funktionelle Cookies um die Leistung der Webseite sicherzustellen und zielorientierte Cookies um das Benutzererlebnis zu verbessern.</small></p>
    ...
    <strong>Cookie Einstellungen sehen und Cookies löschen</strong>
    ...
    <ul>
        <li>Safari: <a href="https://support.apple.com/kb/ph21411?locale=de_AT">Verwalten von Cookies und Websitedaten mit Safari</a></li>
        <li>Firefox: <a href="https://support.mozilla.org/de/kb/cookies-loeschen-daten-von-websites-entfernen">Cookies löschen, um Daten zu entfernen, die Websites auf Ihrem Computer abgelegt haben</a></li>
        <li>Chrome: <a href="https://support.google.com/chrome/answer/95647?co=GENIE.Platform%3DDesktop&hl=de">Cookies in Chrome löschen, aktivieren und verwalten</a></li>
        <li>Internet Explorer: <a href="https://support.microsoft.com/de-at/help/17442/windows-internet-explorer-delete-manage-cookies">Löschen und Verwalten von Cookies</a></li>
    </ul>
    ...
    <strong>Newsletter Datenschutzerklärung</strong>
    ...
    <p>Wir verwenden auf dieser Webseite Funktionen von Facebook, einem Social Media Network der FIrma Facebook Ireland Ltd., 4 Grand Canal Square, Grand Canal Harbour, Dublin 2 Ireland.</p>
    <p>Welche Funktionen (Soziale Plug-ins) Facebook bereitstellt, können Sie auf  <a href="https://developers.facebook.com/docs/plugins/">https://developers.facebook.com/docs/plugins/</a> nachlesen.</p>
    ...
    <p>Die Datenschutzrichtlinien, welche Informationen Facebook sammelt und wie sie diese verwenden finden Sie auf <a href="https://www.facebook.com/policy.php">https://www.facebook.com/policy.php</a>.</p>

    <strong>YouTube Datenschutzerklärung</strong>
    <p>Wir verwenden auf dieser Seite des Videodienstes YouTube, der Firma YouTube, LLC, 901 Cherry Ave., San Bruno, CA 94066, USA.</p>

    <p>Durch das Aufrufen von Seiten unserer Webseite, die YouTube Videos integriert haben, werden Daten an YouTube übertragen, gespeichert und ausgewertet.</p>
    <p>Sollten Sie ein YouTube-Konto haben und angemeldet sein, werden diese Daten Ihrem persönlichen Konto und den darin gespeicherten Daten zugeordnet.</p>

    <p>Welche Daten von Google erfasst werden und wofür diese Daten verwendet werden, können Sie auf <a href="https://www.google.com/intl/de/policies/privacy/">https://www.google.com/intl/de/policies/privacy/</a> nachlesen.</p>

    <strong>Twitter Datenschutzerklärung</strong>
